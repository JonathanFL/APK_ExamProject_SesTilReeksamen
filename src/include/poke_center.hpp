...
/// Pokeball prices
// Pokeball: 200 Poké Dollar
// Greatball: 600 Poké Dollar
// Ultraball: 800 Poké Dollar
// Superpotion: 700 Poké Dollar
// Hyperpotion: 1200 Poké Dollar
struct PokeBagItemPrices
{
    static const int Pokeball = 200;
    static const int Greatball = 600;
    static const int Ultraball = 800;
    static const int Masterball = 9001;
    static const int Superpotion = 700;
    static const int Hyperpotion = 1200;
};
